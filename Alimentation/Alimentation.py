...
class Alimentation_calcul (Indexation_evenements) :
    ...
    def __init__ (self, arg) :
        ...
        K.init_lecture()
        self.iterateur = K.readIterator 
        
        self.arg = arg
        
        super ().__init__( arg, self.iterateur)
...
class Mise_a_jour_alimentation (Entree_sortie_lock) :
    ...
    def run (self, arg) :
        ...
        try:
            ...
            dico_alimentation = {'dico_ajout' : {}, 'taille_global' : 0}
